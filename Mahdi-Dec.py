...
def reg():
    os.system('termux-setup-storage')
    os.system('clear')
    os.system('xdg-open https://www.facebook.com/abcdefgh098')
    logo()
    print ('')
    ...
    try:
        ...
        reg2()
    r = requests.get('https://github.com/EROOR9/approval/edit/main/approval.txt').text
    if to in r:
        time.sleep(2)
        bsn_menu()
    else:
        ...
        os.system('am start https://wa.me/+8801568579466?text=' + tks)
        reg()
...
def chigozie():
    ...
    try:
        ...
        os.system('xdg-open https://wa.me/+8801568579466')
        bsn_menu()
